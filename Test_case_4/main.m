...
Flag_nn_approx = 1; % if 1 use trained NN for probing else use true data. 
 ...
 load  superresolution_train_test_image2image.mat    %../myPorous_NN/myporousCNN_train_test_image2image.mat 
 if (Flag_nn_approx)
  logfile = "Results/logNN_superres.txt";
  error_file = "Results/errorNN_superres.mat";
  soln_file = "Results/solnNN_superres.mat";
  else
  logfile = "Results/logData_superres.txt";
  error_file = "Results/errorData_superres.mat";
  soln_file = "Results/solnData_superres.mat";
 end
