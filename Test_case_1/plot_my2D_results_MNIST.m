function Theta_test =plot_my2D_results_MNIST(Xi,z_input_all_test,f_output,f_output_test,Theta,N2,N,x,y,x_train1,y_train1,index_input_test,index_input_train,y_predict,y_predict_ood,error_file, soln_file)


soln_sindy_train = Theta * Xi;


[Theta_test, eqn_list] = poolData_2d_MNIST_method(N2,N,z_input_all_test,x,y,x_train1,y_train1);  
